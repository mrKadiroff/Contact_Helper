...
import com.example.contact_helper.databinding.FragmentSmsBinding
...
class SmsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val kontaktt = arguments?.getSerializable("kontakt") as Kontakt

        binding.back.setOnClickListener {
            findNavController().popBackStack()
        }

        binding.namee.text = ("${kontaktt.name}  ${kontaktt.number}")
        ...
        binding.send.setOnClickListener {
            askPermission(Manifest.permission.SEND_SMS){
                ...
                obj.sendTextMessage(kontaktt.number,null,sms,null,null)
                findNavController().popBackStack()
